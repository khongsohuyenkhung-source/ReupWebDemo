...
@app.route('/tiktokLHbmWnSSKwxP7Ld2dzL6UMdPrj2pKsC8.txt')
def tiktok_site_verification():
    return 'tiktok-developers-site-verification=LHbmWnSSKwxP7Ld2dzL6UMdPrj2pKsC8', 200, {'Content-Type': 'text/plain; charset=utf-8'}
